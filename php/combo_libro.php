<?php 
	...
	function mostrar_autor(){
			global $opciones;
			$consulta = "select clave_autor,concat(nombre_autor,' ',apellido_autor) as nombre from autores where estado = 'ACTIVO'";
	...
	function mostrar_editorial(){
			global $opciones;
			$consulta = "select clave_editorial, nombre_editorial as nombre from editoriales where status = 'ACTIVO'";
