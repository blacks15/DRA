...
switch ($examp) {
    case 1:
		$result = mysql_query("select COUNT(*) AS count FROM ventas WHERE id=".$id);
		...
		if ($start < 0) $start = 0;
        $SQL = "select dv.clave_producto as codigo,l.nombre_libro as producto,dv.cantidad,dv.precio,
        		dv.subtotal 
