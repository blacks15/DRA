...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2015 a las 20:45:32
...
(3, 1, 2, 1515, 10, 1, '150', '200', 'DISPONIBLE'),
(4, 2, 3, 151515, 10, 1, '200', '251', 'DISPONIBLE');
...
--
ALTER TABLE `clientes`
  MODIFY `matricula` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
